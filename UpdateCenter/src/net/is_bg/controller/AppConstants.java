...
public class AppConstants {
	...
	public enum CONTEXTPARAMS{
		...
		SERVER_LIB_DIR(serverlibdir, ContextUtils.getParam(serverlibdir, String.class, "none"), String.class),
		LTF_UPDATE_ROOT_DIR(ltfupadterootdir, ContextUtils.getParam(serverlibdir, String.class, "D:\\updatecenterroot"), String.class),
		...
		LTF_DEPLOY(deploy, ContextUtils.getParam(ltfwar, Boolean.class, false), Boolean.class),
